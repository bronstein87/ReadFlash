...
struct CadrInfo
{
	_fastcall CadrInfo(): Time(0), DeviceInfo("empty"), FrameNumber(0), CountStars(0), CountWindows(0),
	CountLocalObj(0), CountDeterObj(0), SizeStarsList(0), SizeWindowsList(0), SizeObjectsList(0),
	 CountLines(0), CountBlock(0), MeanErrorX(0), MeanErrorY(0), MeanErrorXY(0), MeanBright(0), SigmaBright(0),
